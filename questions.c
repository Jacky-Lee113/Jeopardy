...
void display_categories(void)
{
	...
	printf("+-----------------------+-----------------------+----------------------+\n");
	printf("| $%d%s                | $%d%s                | $%d%s               |\n", questions[0].value, questions[0].buffer, questions[4].value, questions[4].buffer, questions[8].value, questions[8].buffer);
	printf("+-----------------------+-----------------------+----------------------+\n");
	printf("| $%d%s                | $%d%s                | $%d%s               |\n", questions[1].value, questions[1].buffer, questions[5].value, questions[5].buffer, questions[9].value, questions[9].buffer);
	printf("+-----------------------+-----------------------+----------------------+\n");
	printf("| $%d%s                | $%d%s                | $%d%s               |\n", questions[2].value, questions[2].buffer, questions[6].value, questions[6].buffer, questions[10].value, questions[10].buffer);
	printf("+-----------------------+-----------------------+----------------------+\n");	
	printf("| $%d%s                | $%d%s                | $%d%s               |\n", questions[3].value, questions[3].buffer, questions[7].value, questions[7].buffer, questions[11].value, questions[11].buffer);
	printf("+-----------------------+-----------------------+----------------------+\n");
	printf("\033[0m");
}
